...
$l['add_post_icon_desc'] = "Buradan yeni bir mesaj ikonu ekleyebilirsiniz.";
...
$l['edit_post_icon_desc'] = "Buradan bir mesaj ikonunu düzenleyebilirsiniz.";
...
$l['error_missing_name'] = "Bu mesaj ikonu için bir isim girmediniz.";
$l['error_missing_path'] = "Bu mesaj ikonu için bir resim yolu girmediniz.";
$l['error_missing_path_multiple'] = "Bir resim yolu girmediniz";
$l['error_invalid_path'] = "Uygun bir resim yolu girmediniz";
$l['error_no_images'] = "Belirtilen klasörde mesaj ikonu bulunmamaktadır ya da klasördeki tüm mesaj ikonları zaten eklenmiş.";
$l['error_none_included'] = "İçermesi için herhangi bir mesaj ikonu seçmediniz.";
$l['error_invalid_post_icon'] = "Belirtilen mesaj ikonu mevcut değil.";

$l['success_post_icon_added'] = "Mesaj ikonu başarılı bir şekilde eklendi.";
$l['success_post_icons_added'] = "Seçilen mesaj ikonları başarılı bir şekilde eklendi.";
$l['success_post_icon_updated'] = "Mesaj ikonu başarılı bir şekilde güncellendi.";
$l['success_post_icon_deleted'] = "Belirtilen mesaj ikonu başarılı bir şekilde silindi.";
