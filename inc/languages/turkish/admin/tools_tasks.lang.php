...
$l['confirm_task_enable'] = "<strong>UYARI:</strong> Bir UNIX komutu yoluyla çalıştırılacak görevi etkinleştirmektesiniz. (Daha fazla bilgi için lütfen <a href=\"http://docs.mybb.com/Help-Task_System.html\" target=\"_blank\">MyBB Docs</a> adresini ziyaret edin). Devam et?";
$l['no_tasks'] = "Şu anda çalışan hiçbir görev yok.";
