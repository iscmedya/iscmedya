...
<br /><br />Kayıt olan kullanıcıların genel özellikler arasında kişisel not alanı, email ve stil değişikliği abonelikleri vardır.';
...
<br /><br />Bu forumdan gelen çerezleri temizlemek için <a href="misc.php?action=clearcookies&amp;my_post_key={1}">buraya</a> tıklayabilirsiniz.';
...
<br /><br />Giriş yapmak için, forumun üst kısmındaki giriş bağlantısını tıklayın. Oturumu kapatmak için, aynı yerde Oturumu Kapat seçeneğini kullanın. Giriş ve çıkış sorunu yaşarsanız tarayıcınızın çerezlerini temizleyip tekrar deneyin.';
// Help Document 5
...
<p><br />[url]http://www.mybbkursu.com/[/url]<br />&nbsp;&nbsp;&nbsp;<a href="http://www.mybbkursu.com/">http://www.mybbkursu.com/</a> 
<p>[url=http://www.mybbkursu.com/]MyBBKursu.Com[/url]<br />&nbsp;&nbsp;&nbsp;<a href="http://www.mybbkursu.com/">MyBBKursu.Com</a> 
